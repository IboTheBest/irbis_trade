    ...
    return (
        <header className="site-header pb-[100px] z-[2]">
            <div className="containers">
                <nav className="top-0 bg-[#00000070] fixed w-full mx-auto left-0 right-0 md:flex items-center justify-between py-[10px]">
                    <a className="ml-[30px]" href="./index.html">
                        <img
                            className='untouchable'
                            src="https://firebasestorage.googleapis.com/v0/b/cyber-beta-204b9.appspot.com/o/new_irbis_files%2Flogo.svg?alt=media&token=91595f4b-c369-4b3c-b460-07fb760d5570"
                            alt="site logo"
                            width="144"
                            height="112"
                        />
                    ...
                    <button className="mr-[30px] md:hidden">
                        <img className='untouchable' src="./images/manu.svg" alt="open navbar menu" width="40" height="40" />
                    </button>
                ...
                <div className="pt-[112px]">
                    <div className="text-center mx-auto max-w-[900px] mt-[80px]">
                        <strong className="uppercase text-[#00bfff] text-[15px] md:text-[24px] mb-[50px]">
                            ТАМОЖЕННОЕ ОФОРМЛЕНИЕ
                        </strong>
                        <h2 className="uppercase text-[23px] md:text-[48px] font-bold text-white">
                            Универсальное решение для всех ваших потребностей в таможне и логистике
                        </h2>
                    </div>
                    <ul className="flex items-center justify-center gap-10 md:gap-20 flex-wrap mt-10">
                        {[
                            ...
                            <li key={index} className="flex flex-col items-center">
                                <img
                                    className='untouchable'
                                    src={`https://firebasestorage.googleapis.com/v0/b/cyber-beta-204b9.appspot.com/o/new_irbis_files%2F${item.src}.svg?alt=media`}
                                    alt={item.src}
                                    width="110"
                                />
                    ...
                    <div className="flex items-center justify-center mt-[50px] gap-[20px]">
                        <a className="bg-white border-none rounded-full w-[270px] h-[55px] font-bold transition-all duration-700 text-[#00bfff] hover:bg-[#00bfff] text-center hover:text-white flex items-center justify-center">
                            Оформить груз
                        </a>
                        <a className="bg-white border-none rounded-full w-[270px] h-[55px] font-bold transition-all duration-700 text-[#00bfff] hover:bg-[#00bfff] text-center hover:text-white flex items-center justify-center">
